...
namespace DirekPansiyon
{
    public partial class FrmYeniMüsteri : Form
    {
        ...
        {
            MessageBox.Show("Kırmızı renkler dolu odaları gösterir...");
        }

        private void BtnBosOda_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Yeşil renkler boş odaları gösterir...");
        }
        ...
        private void DtpCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            ...
            Ucret = Convert.ToInt32(label11.Text) * 750;
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand(
                        "INSERT INTO MüsteriEkle (Adi, Soyadi, Cinsiyet, Telefon, Mail, TcKimlikNo, OdaNo, Ucret, [Giris Tarihi], [Cikis Tarihi]) " +
                        "VALUES ('" + TxtAdi.Text + "', '" + TxtSoyadi.Text + "', '" + comboBox1.Text + "', '" + MskTxtTelefon.Text + "', '" +
                        TxtMail.Text + "', '" + TxtKimlikNo.Text + "', '" + TxtOdaNo.Text + "', '" + TxtUcret.Text + "', '" +
